...
<div class="box">
  <div class="box-header">
    ...
    <div class="col-md-2" style="padding: 150;">
      ...
      <tbody id="data-delivery">
       ...
       ?>
                <tr>
                    ...
                    <td><?php echo $delivery->nik_pegawai; ?></td>
...
<script type="text/javascript">
  $(document).on("click", ".tambah-pengiriman", function() {
    $.ajax({
      url: "<?php echo base_url('DeliveryMenu/deliverys'); ?>"
    })
    .done(function(data) {
      $('#tempat-modal').html(data);
      $('#tambah-pengiriman').modal('show');
    })
  })
</script>