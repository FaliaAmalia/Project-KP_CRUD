...
<body>
    ...
    <h1 align="center">Data Summary</h1>
    <hr>
    ...
    <form method="get" action="" >
        ...
        <br><br>
<a href="<?php echo base_url('Summary'); ?>"> Kembali </a>
&nbsp <a href="<?php echo base_url('ReportSummary'); ?>"> Riset Filter</a>
...
//    		echo "<td>".$tgl."</td>";
    ...
    <script> var loader2 = document.getElementById('loader2');
