                                ...
                                <tr>
                                    <td><?php
                                        foreach ($dataSummary as $summary) {
                                            ?>
                                            <img src="<?= base_url('../uploads/' . $summary->image); ?>"width="150" height='200' class="rounded" >
                                            <?php
                                        }
                                        ?></td>
                                    <td><?php foreach($dataSummary as $summary) { ?>
                                        <p style='margin-left:50px; margin-bottom:20px; padding-top: 15px;'>Name&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $summary->name; ?></p>
                                        <p style='margin-left:50px; margin-bottom:20px;'>NIK&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $summary->nik; ?></p>
<!--                                        <p style='margin-left:50px; margin-bottom:20px;'>Position&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $laporan->posisition; ?></p>-->
                ...
                <table id="tabel-detail" class="table table-bordered table-striped">
                    ...
                    <tbody id="data-guest">
                        <?php
                        foreach ($dataSummaryGuest as $guest) {
                            ?>
                            <tr>
