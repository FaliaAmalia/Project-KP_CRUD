...
<div class="text-left noprint" >
                <button class="btn btn-danger" OnClick="javascript:window.print()" > Download PDF</button>
                        ...
                        <h1 style="display:block; text-align:center;"><i class="fa fa-briefcase"></i>Detail Summary Delivery</h1>
                        <!-- <table border='0'>
                            <tbody>
                                <tr> -->
                        ...
                        <table id="tabel-detail" class="table table-bordered table-striped">
                            ...
                            <tbody>
                                <?php
                                foreach ($dataSummaryDeliveri as $summarydelivery2) {
                                    ?>
                                    <tr>
                                        <td><?php echo $summarydelivery2->date_time; ?></td>

                                        <td><?php echo $summarydelivery2->id_delivery; ?></td>
                                        <td><?php echo $summarydelivery2->type_deliv; ?></td>
                                        <td><?php echo $summarydelivery2->sub_type; ?></td>
                                        <td><?php echo $summarydelivery2->no_resi; ?></td>
                                        <td><?php echo $summarydelivery2->nik_pegawai; ?></td>
                                        <td><?php echo $summarydelivery2->jmlh_barang; ?></td>
                                        <td><?php echo $summarydelivery2->jenis_barang; ?></td>
                                        <td><?php echo $summarydelivery2->front_desk; ?></td>
                                        <td><?php echo $summarydelivery2->deliv_status; ?></td>
