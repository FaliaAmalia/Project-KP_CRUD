<html>
    <head>
        <title>Report Event <?php echo $laporanevent->title; ?></title>
                        ...
                        <table border='0'>
                            <tbody>
                                <tr>
                                    ...
                                    <td><?php foreach($dataLaporanevent as $laporanevent) { ?>
                                        <p style='margin-left:50px; margin-bottom:20px; padding-top: 15px;'>Title&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $laporanevent->title; ?></p>
                                        <p style='margin-left:50px; margin-bottom:20px;'>Date&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $laporanevent->date; ?></p>
                                        <p style='margin-left:50px; margin-bottom:20px;'>Employee&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $laporanevent->employee; ?></p>
                                    <?php } ?>
                                    </td>
                                </tr>
                            </tbody>
