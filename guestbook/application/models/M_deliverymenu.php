...
class M_deliverymenu extends CI_Model {
    ...
    public function insert_delivery($data_deliv){
    ...
    public function select_by_jmlh($idDeliv) {
        $sql = "SELECT COUNT(*) AS jmlh FROM delivery";
        // $sql = "SELECT * FROM delivery WHERE id_delivery = {$idDeliv}";
        $data = $this->db->query($sql);
    ...
    public function select_by_counttype($idDeliv) {
        $sql = " SELECT COUNT(*) AS totalsub FROM delivery WHERE delivery.sub_type = sub_type";
    ...
    public function insertd($data_deliv) {
    ...
    public function select_get_all() {
