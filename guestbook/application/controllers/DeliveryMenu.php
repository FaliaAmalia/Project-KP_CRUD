...
class DeliveryMenu extends AUTH_Controller {
    ...
    public function save()
    {
        ...
        $this->nik_pegawai = $post["nik_pegawai"];
    ...
    {
        //$data['dataEmployee'] = $this->Eventm->select_all_employee();
        //$x['invoice']=$this->Eventm->get_no_invoice();
        $data_deliv = array(
            'dataDelivery'  => $this->M_deliverymenu->select_get_all(),
            // 'invoice' => $this->Eventm->get_no_invoice()
        );
        echo show_my_modal('modals/modal_tambah_pengiriman', 'tambah-pengiriman', $data_deliv);
    }
    ...
    public function prosesTambah()
    {
        ...
        // $date_time = $this->input->post(date_time_set(), true);
        ...
        $result = $this->M_deliverymenu->insertd($data_deliv);
    ...
    public function prosesUpdate() {
        ...
        $this->form_validation->set_rules('nik_pegawai', 'nik_pegawai', 'trim|required');
