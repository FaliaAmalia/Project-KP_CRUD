...
class ChartDeliv extends AUTH_Controller {

    public function __construct() {
        parent::__construct();
        $this->load->model('M_chartd4');
    }

    public function index() {
        $data['userdata'] = $this->userdata;
        $data['data_pen'] = $this->M_chartd4->select_all();
        ...
        $appointment = $this->M_chartd4->select_all(); 


        $data['ket'] = $ket;
        $data['url_cetak'] = base_url('index.php/' . $url_cetak);
        $data['dataAppointment'] = $appointment;
        $data['option_tahun'] = $this->M_chartd4->option_tahun();
    }

    public function tampil() {
        $data['dataAppointment'] = $this->M_chartd4->select_all();
